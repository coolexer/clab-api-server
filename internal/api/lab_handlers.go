...
// @Summary Inspect lab
// @Description Returns details for a specific running lab. When the optional `topology` query
// @Description parameter is set to `true`, the response switches to an object that includes both
// @Description the container list and the raw contents of topology-data.json generated by
// @Description containerlab in the lab directory.
// @Tags Labs
// @Security BearerAuth
// @Produce json
// @Param labName path string true "Name of the lab to inspect"
// @Param topology query bool false "When true, wrap response and include topology-data.json"
// @Success 200 {object} []models.ClabContainerInfo "Lab containers (topology=false, default)"
// @Success 200 {object} models.InspectLabResponse "Lab containers + topology data (topology=true)"
// @Failure 400 {object} models.ErrorResponse "Invalid lab name"
// @Failure 401 {object} models.ErrorResponse "Unauthorized"
// @Failure 404 {object} models.ErrorResponse "Lab not found"
// @Failure 500 {object} models.ErrorResponse "Internal server error"
...
func InspectLabHandler(c *gin.Context) {
	username := c.GetString("username")
	labName := c.Param("labName")
	includeTopology := c.Query("topology") == "true"
	...
	c.JSON(http.StatusOK, models.InspectLabResponse{
