    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "name": "directory_request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.WorkspaceDirectoryRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Directory create success",
                        "schema": {
        ...
        "/api/v1/labs/workspace/events": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Workspace file event stream",
                        "schema": {
                            "$ref": "#/definitions/models.WorkspaceFileEventResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.WorkspaceFileRenameRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.WorkspaceFileEntry"
                            }
                        }
                    },
                    "400": {
        ...
        "/api/v1/labs/{labName}": {
            "get": {
                ...
                "description": "Returns details for a specific running lab. When the optional ` + "`" + `topology` + "`" + ` query\nparameter is set to ` + "`" + `true` + "`" + `, the response switches to an object that includes both\nthe container list and the raw contents of topology-data.json generated by\ncontainerlab in the lab directory.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "parameters": [
                    ...
                    {
                        "type": "boolean",
                        "description": "When true, wrap response and include topology-data.json",
                        "name": "topology",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Lab containers + topology data (topology=true)",
                        "schema": {
                            "$ref": "#/definitions/models.InspectLabResponse"
                        }
                    },
                    "400": {
        ...
        "/api/v1/labs/{labName}/nodes/{nodeName}/restart": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "models.ClabContainerInfo": {
            ...
            "properties": {
                ...
                "nodeName": {
                    "description": "Topology node name from containerlab labels",
                    "type": "string"
                },
                "owner": {
        ...
        "models.GenerateResponse": {
            ...
            "properties": {
                ...
                "savedFilePath": {
                    "description": "Path where the file was saved (if Deploy=true, it's the path in the user's managed lab directory; if Deploy=false, it's the OutputFile path if provided).",
                    "type": "string"
                },
                "topologyYaml": {
        ...
        "models.WorkspaceDirectoryRequest": {
            "type": "object",
            "required": [
                "path"
            ],
        ...
        "models.WorkspaceFileEventResponse": {
            "type": "object",
            "properties": {
                "action": {
                    "type": "string",
                ...
                "path": {
                    "type": "string",
                    "example": "lab1/configs/startup.cfg"
                },
                "type": {
                    "type": "string",
        ...
        "models.WorkspaceFileRenameRequest": {
            "type": "object",
            "required": [
                "newPath",
                "oldPath"
            ...
            "properties": {
                "newPath": {
                    "type": "string",
                    "example": "lab1/configs/startup.bak.cfg"
                },
                "oldPath": {
                    "type": "string",
                    "example": "lab1/configs/startup.cfg"
