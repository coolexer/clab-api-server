...
#
# Quick examples:
#   curl -fsSL https://raw.githubusercontent.com/coolexer/clab-api-server/main/install.sh \
#     | sudo bash -s -- install
#
#   curl -fsSL https://raw.githubusercontent.com/coolexer/clab-api-server/main/install.sh \
...
#
#   curl -fsSL https://raw.githubusercontent.com/coolexer/clab-api-server/main/install.sh \
#     | sudo bash -s -- upgrade --version v0.1.2
#
#   curl -fsSL https://raw.githubusercontent.com/coolexer/clab-api-server/main/install.sh \
...
# Files are stored under \$CLAB_LABS_ROOT/<username>/ when set.
