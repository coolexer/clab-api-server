...
```bash
curl -fsSL https://raw.githubusercontent.com/coolexer/clab-api-server/main/install.sh | sudo bash -s -- install
```
...
curl -fsSL https://raw.githubusercontent.com/coolexer/clab-api-server/main/install.sh | sudo -E bash -s -- install
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/coolexer/clab-api-server/main/install.sh | sudo bash -s -- pull-only
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/coolexer/clab-api-server/main/install.sh | sudo bash -s -- upgrade
curl -fsSL https://raw.githubusercontent.com/coolexer/clab-api-server/main/install.sh | sudo bash -s -- upgrade --version v0.1.2
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/coolexer/clab-api-server/main/install.sh | sudo bash -s -- uninstall
```

Remove the configuration intentionally with `--purge`:

```bash
curl -fsSL https://raw.githubusercontent.com/coolexer/clab-api-server/main/install.sh | sudo bash -s -- uninstall --purge
```
